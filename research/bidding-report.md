...
Legend, used throughout: **length dists** are per-length percentages (tails
lumped as `<k`/`k+`). **texture** is a 0–10 suit-quality index — cards A…7
weighted top-down plus a bonus per touching pair, normalised so a solid
AKQJT-suit = 10 at any length (QJT98 ≈ 5.3, KQ743 ≈ 4.4, jack-high rags ≈ 1);
shown as median (p25–p75). **%bal** counts strictly balanced shapes only:
4-3-3-3, 4-4-3-2, 5-3-3-2 — no singleton or void, no 6-card suit, and 5-4
patterns don’t count either.

| auction | n | HCP | fav | unfav | bid suit | texture | filter |
|---|---|---|---|---|---|---|---|
| (1C) 1H | 2063 | 7–16 (med 10) | 10 | 10 | 4:3% 5:66% 6:23% 7:7% | **4.6** (3.7–5.4) | `h >= 5 and top(h,5) >= 1 and hcp in 7..16` |
| (1C) 1S | 2420 | 7–15 (med 11) | 9 | 12 | <5:2% 5:81% 6:15% 7:2% | **4.3** (3.2–5.0) | `s >= 5 and top(s,5) >= 1 and hcp in 7..15` |
| (1D) 1S | 2159 | 7–15 (med 10) | 10 | 10 | 4:3% 5:77% 6:17% 7:3% | **4.2** (3.0–5.3) | `s >= 5 and top(s,5) >= 1 and hcp in 7..15` |
| (1D) 1H | 2066 | 7–16 (med 11) | 11 | 11 | 4:4% 5:63% 6:33% 7+:1% | **4.6** (3.5–5.8) | `h >= 5 and top(h,5) >= 1 and hcp in 7..16` |
| (1H) 1S | 1418 | 7–16 (med 12) | 13 | 10 | 4:3% 5:72% 6:21% 7:4% | **5.4** (3.7–6.5) | `s >= 5 and top(s,5) >= 1 and ((hcp in 6..16 and h <= 2) or (hcp in 8..16 and h in 3..4))` |
| (1H) 2C | 477 | 9–17 (med 12) | 11 | 11 | 5:21% 6:59% 7:20% | **5.6** (4.7–6.7) | `c >= 5 and top(c,5) >= 2 and hcp in 9..17` |
| (1S) 2H | 859 | 10–15 (med 12) | 10 | 13 | 5:45% 6:51% 7:3% | **5.4** (4.3–6.3) | `h >= 5 and top(h,5) >= 1 and (hcp >= 11 or top(h,5) >= 2) and ((hcp in 10..15 and s <= 2) or (hcp in 11..15 and s == 3))` |
